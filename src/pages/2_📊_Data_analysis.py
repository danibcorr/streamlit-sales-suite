...
def main(dataset_path: str) -> None:
    ...
    year_label = (
        year_label if language == "English" else translator.translate(year_label)
    )
    compare_label = "Compare years"
    compare_label = (
        compare_label if language == "English" else translator.translate(compare_label)
    )
    ...
    if compare_years_checkbox:
        ...
        year1_label = (
            year1_label if language == "English" else translator.translate(year1_label)
        )
        year2_label = "Select the second year"
        year2_label = (
            year2_label if language == "English" else translator.translate(year2_label)
        )
